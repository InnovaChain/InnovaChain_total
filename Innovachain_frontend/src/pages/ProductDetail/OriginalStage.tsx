  ...
  return (
    <CardContainer className="flex-1">
      ...
      <div className="flex justify-between items-end">
        ...
        <div className="flex gap-1">
          <button className={clsx(
            "bg-[#0066D4] px-2 py-1 rounded-full text-white font-medium"
          )}>
            Verified
          </button>
        </div>
      </div>
      <p className="text-[#888888B2] text-xl mt-10 mb-20">Recreation of famous NFT Azuki.</p>
      ...
      <div className="mt-5 flex flex-col gap-2">
        ...
        <DarkButton className="w-full h-20 rounded-[20px] bg-black text-white font-bold  text-lg"
          onClick={onClickRecreated}>
          Recreated
        </DarkButton>
      </div>
    </CardContainer>
