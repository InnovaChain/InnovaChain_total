...
const HeroSection = () => {
    return (
        <Container className="grid grid-cols-2 !pr-0 py-[100px] mb-[150px]">
            <div>
                <Title>Traceable Art, Anyone, Anywhere & Anything</Title>
                <Description>Protect your copyright, legally make recreation, gain income through distribution, expand your ip.</Description>
                <HeroDataSection>
            ...
            <div className="relative">
                <img className="absolute left-0 top-0 w-[350px] h-[350px]" src={Image0Img} alt="bg-left-light" />
                <img className="absolute right-0 top-[200px] w-[250px] h-[250px]" src={Image1Img} alt="bg-left-light" />
                <ImageController />
            </div>
        </Container>
    );
...
const ImageController = () => {
    return (
        <div className={clsx("absolute left-[90px] top-[420px] p-5 rounded-2xl", "bg-[#FCFCFD] flex items-center gap-8")}>
